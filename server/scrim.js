 ...
 *
 * ELO: one update per series on WHO TAKES THE SERIES (win=1, loss=0, a
 * 50-50 split counts half), delta = K * (result - E). Margins display on
 * the ladder but do not move ratings.
 */
'use strict';
