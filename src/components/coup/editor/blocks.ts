...
function getTheme(): Blockly.Theme {
  ...
  theme = Blockly.Theme.defineTheme('coupDark', {
    ...
    componentStyles: {
      // mirrors the light palette in coup.css (--bg-2, --panel, --ink, --accent)
      workspaceBackgroundColour: '#f3f1ea',
      toolboxBackgroundColour: '#ffffff',
      toolboxForegroundColour: '#2a3038',
      flyoutBackgroundColour: '#f5f2ea',
      flyoutForegroundColour: '#6f7a84',
      flyoutOpacity: 1,
      // deeper than --line so it stays visible at 0.6 opacity on a light workspace
      scrollbarColour: '#b8b1a0',
      scrollbarOpacity: 0.6,
      insertionMarkerColour: '#a8842c',
      insertionMarkerOpacity: 0.5,
      cursorColour: '#a8842c',
      selectedGlowColour: '#a8842c',
    },
    categoryStyles: {
