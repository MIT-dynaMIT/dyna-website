  ...
  return (
    <>
      <div className="text-center">
        <h1 className="mb-5 font-display text-4xl font-extrabold tracking-tight sm:text-5xl">
          Join dynaMIT
        </h1>
        <p className="mx-auto mb-16 max-w-3xl text-lg leading-relaxed text-dark/75">
      ...
      <div>
        ...
        <div className="mt-16 rounded-2xl bg-white p-7 text-left ring-1 ring-dark/5 shadow-card sm:p-8">
          <h2 className="mb-5 font-display text-2xl font-bold text-dark">Important Dates</h2>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              <h3 className="mb-1 font-semibold text-dark">Week 1 — Rising 6th/7th Graders</h3>
              <p className="text-dark/80">{formatDateToReadableString(week1Start)} to {formatDateToStringWithYear(week1End)}</p>
            </div>
            <div>
              <h3 className="mb-1 font-semibold text-dark">Week 2 — Rising 8th/9th Graders</h3>
              <p className="text-dark/80">{formatDateToReadableString(week2Start)} to {formatDateToStringWithYear(week2End)}</p>
            </div>
          </div>
          <div className="mt-6 border-t border-dark/5 pt-5">
            <p className="text-dark/75">
              ...
              please check our <a href="/#faq" className="font-medium text-primary hover:underline">FAQ</a> or contact us directly.
            </p>
          </div>
        </div>
      </div>
